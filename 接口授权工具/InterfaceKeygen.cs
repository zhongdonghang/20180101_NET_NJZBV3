...
namespace 接口授权工具
{
    public partial class InterfaceKeygen : Form
    {
        public InterfaceKeygen()
        {
            InitializeComponent();
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            if (!string.IsNullOrEmpty(textBox1.Text))
            {
                ...
                string pass = SeatManage.SeatManageComm.MD5Algorithm.GetMD5Str32WithListKey(new List<string>() { textBox1.Text, interfacekey });
