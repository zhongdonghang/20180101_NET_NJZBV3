<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BookSeatMessage.aspx.cs"
    Inherits="WeiXinPocketBookOnline.BookSeat.BookSeatMessage" %>
...
<head id="Head1" runat="server">
    ...
    <script>
        ...
        function GoBookSeatListForm() {
            window.location.href = "BookSeatListForm.aspx";
        }
    </script>
</head>
<body>
    ...
    <div data-role="page" id="page1" runat="server">
        ...
        <div data-role="content">
            ...
            <div class="ui-grid-a">
                ...
                <div class="ui-block-a" id="bookMode_sp" runat="server" style="width: 50%; height: 40px; text-align: right;line-height:0px; vertical-align:middle">
                    <span >
                        <h5>
                            预约方式：</h5>
                    </span>
