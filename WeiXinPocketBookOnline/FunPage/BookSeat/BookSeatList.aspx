<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BookSeatList.aspx.cs" Inherits="WeiXinPocketBookOnline.FunPage.BookSeat.BookSeatList" %>
...
<head id="Head1" runat="server">
    ...
    <script>
        ...
        function ShowBookMessage(seatNo) {
            var rrid = $("#hidRrId").val();
            var bookDate = $('#txtBookDate').val();
            window.location.href = "BookNowSeatMessage.aspx?seatNo=" + seatNo +  "&roomNo=" + rrid + "&bookDate=" + bookDate;
        }
    ...
    <form id="form1" runat="server">
        ...
        <div data-role="page" id="page1">
            ...
            <div data-role="content">
                ...
                <input type="text" data-mini="true" name="txtBookDate" id="txtBookDate" onchange="subQuery('bind')"
                    runat="server" onfocus="DateOnfocus()" />
            </div>
               <div data-role="fieldcontain">
                <table width="100%">
                    <tr>
                ...
                <asp:DataList ID="DataListBookSeat" runat="server" RepeatDirection="Horizontal" RepeatColumns="4"
                    ...
                    <ItemTemplate>
                        <div id="divItem" runat="server" data-role="fieldcontain" style="width: 25%; height: 30px; margin-left: 0; margin-top: 0">
                            <div onclick='ShowBookMessage(&quot;<%# Eval("SeatNo")%>&quot;)'
                                data-inline="true" data-transition="none" data-role="button" style="width: 69px; text-align: center; margin-left: 0; margin-top: 0">
                                <%# Eval("SeatShortNo")%>
                            </div>
                        </div>
                    </ItemTemplate>
