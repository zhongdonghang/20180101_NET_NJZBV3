<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BlackList.aspx.cs" Inherits="WeiXinPocketBookOnline.UserInfos.BlackList" %>
...
<body>
    ...
    <div data-role="page" id="about">
        ...
        <div data-role="navbar" data-theme="d">
            <ul>
                <li><a href="#" onclick="setPageValue('ViolateDiscipline')" id="vLi" runat="server">
                    违规记录</a></li>
                <li><a href="#" class="ui-btn-active" onclick="setPageValue('blacklist')" id="bLi"
                    runat="server">黑名单记录</a></li> 
            </ul>
        </div>
