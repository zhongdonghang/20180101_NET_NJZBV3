...
namespace SeatClientV2.ViewModel
{
    public class RoomSeatWindow_ViewModel : INotifyPropertyChanged
    {
        ...
        public bool WaitSeat(SeatButton seatBtn)
        {
            ...
            {
                PopupWindow popWindow = new PopupWindow(SeatManage.EnumType.TipType.WaitSeatWithSeat);
                CountDown.Pause();
            ...
            {
                PopupWindow popWindow = new PopupWindow(SeatManage.EnumType.TipType.WaitSeatFrequent);
                CountDown.Pause();
                popWindow.ShowDialog();
                CountDown.Start();
                return false;
            ...
            if (lockseat == SeatManage.EnumType.SeatLockState.Locked)//座位成功加锁
            {
                ...
                PopupWindow popWindow = new PopupWindow(SeatManage.EnumType.TipType.SetShortWarning);
                CountDown.Pause();
                popWindow.ShowDialog();
                CountDown.Start();
