...
namespace SeatClientV2.ViewModel
{
    public class ReadingRoomWindow_ViewModel : INotifyPropertyChanged
    {
        public ReadingRoomWindow_ViewModel()
        {
            ...
            {
                //ReaderAdOImage = clientObject.ReaderAdvert.ReaderImage;
                ...
                clientObject.ReaderAdvert.Usage.WatchCount++;
            }
            GetRoomUsage();
        }
        ...
        private Dictionary<string, List<SeatClientV2.ViewModel.ReadingRoomUC_ViewModel>> _ReadingRoomUsage = new Dictionary<string, List<ReadingRoomUC_ViewModel>>();
        /// <summary>
        /// 阅览室
        /// </summary>
        public Dictionary<string, List<SeatClientV2.ViewModel.ReadingRoomUC_ViewModel>> ReadingRoomUsage
        {
