...
namespace SeatClientV2.Code
{
    ...
    {
        System.Threading.Thread printThread;
        ...
        public void ThreadPrint(PrintStatus printType, PrintData data, string clientNo)
        {
            ...
            printThread = new System.Threading.Thread(new System.Threading.ThreadStart(Print));
            printThread.Start();
        }
            ...
            System.Windows.Application.Current.Dispatcher.Invoke(new Action(() =>
             {
                 ...
                 TerminalInfoV2 term = SeatManage.Bll.TerminalOperatorService.GetTeminalSetting(ThreadClientNo);
