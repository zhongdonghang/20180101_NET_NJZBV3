...
namespace SeatService.MonitorService.Code
{
    public partial class SeatDataOperation
    {
        ...
        /// 数据服务
        /// </summary>
        private WcfServiceForSeatManage.SeatManageDateService seatManageService = new SeatManageDateService();
        /// <summary>
        /// 构造函数
        /// </summary>
        ...
        public void GetSetting()
        {
            try
            {
                ...
                regulationRulesSetting = seatManageService.GetRegulationRulesSetting();
                roomList.Clear();
        ...
        public void LockOverTime()
        {
            try
            {
                ...
                //获取全部的锁定座位
                List<Seat> SeatList = seatManageService.GetSeatListByReadingRoom(null, true);
                if (SeatList != null)
                {
                    foreach (Seat s in SeatList)
                    {
                        ...
                        {
                            seatManageService.SeatUnLocked(s.SeatNo);
                        }
                    }
                }
            }
