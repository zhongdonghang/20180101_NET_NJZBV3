...
namespace SeatClientV3.Code
{
    ...
    public class NowReadingRoomState
    {
        ...
        { }
        public NowReadingRoomState(ReadingRoomInfo room, bool IsGetUsingState)
            : this(room, DateTime.Now, IsGetUsingState)
        { }

        public NowReadingRoomState(ReadingRoomInfo room, DateTime Time, bool IsGetUsingState)
        {
            //根据设置判断当前阅览室的选座方式
        ...
        {
            //TODO:获取阅览室内座位的使用状态; 
            Dictionary<string, ReadingRoomSeatUsedState> seatUsedState = SeatManage.Bll.NowReadingRoomState.GetRoomSeatUsedState(roomNums);
