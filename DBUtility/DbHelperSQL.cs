...
namespace DBUtility
{
    ...
    public abstract class DbHelperSQL
    {
        ...
        /// <param name="SQLString">查询语句</param>
        /// <returns>DataSet</returns>
        public static DataSet Query(string SQLString, string DSName, string TableName)
        {
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
        ...
        /// <param name="SQLString">查询语句</param>
        /// <returns>DataSet</returns>
        public static DataSet Query(string SQLString, string TableName, DataSet FDS)
        {
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
        ...
        /// <returns></returns>
        public static DataTable Execute_Proc(string Proc_Name, SqlParameter[] parameters)
        {
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
        ...
        /// <returns></returns>
        public static byte[] GetBytesFromReader(SqlDataReader reader, int index)
        {
        ...
        public static string strConnnetString
        {
            get
            {
                return SetConnetString("ConnectionString");
            }
