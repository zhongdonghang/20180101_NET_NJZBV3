...
{
    public class VM_UC_RoomStatus : VM_BasicModel
    {
        /// <summary>
        /// 阅览室名称
        /// </summary>
        ...
        /// 使用状态
        /// </summary>
        private ReadingRoomUsingStatus _UsingStatus = ReadingRoomUsingStatus.Normal;
        /// <summary>
        /// 开闭状态
        /// </summary>
        ...
        public ReadingRoomUsingStatus UsingStatus
        {
            ...
            set { _UsingStatus = value; Changed("ArcColor"); }
        }
        ...
        {
            get { return _UsingCount + "/" + _BookingCount + "/" + _AllSeatCount; }
        }
        /// <summary>
        /// 显示角度
        /// </summary>
