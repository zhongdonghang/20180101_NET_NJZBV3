<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WaitSeatListForm.aspx.cs" Inherits="SchoolPocketBookOnlineV2.WaitSeat.WaitSeatListForm" %>
...
<head id="Head1" runat="server">
    ...
    <script>
        ...
        function OpenBookMessage() {
            window.showModalDialog("BookSeatMessage.aspx", "", "dialogWidth=300px;dialogHeight=300px;scroll:no;status=no");
        }
        function subQuery(cmd) {
            document.getElementById("subCmd").value = cmd;
            form1.submit();
        }
        function ShowWaitMessage(seatNo, seatShortNo) {
            var No = seatNo;
            var ShortNo = seatShortNo;
            var rrid = $("#hidRrId").val();
            var bookDate = $('#txtBookDate').val();
            window.location.href = "WaitSeatMessage.aspx?seatNo=" + No + "&seatShortNo=" + ShortNo + "&roomNo=" + rrid;
        }
...
<body>
    ...
    <div data-role="page" id="page1">
        ...
        <div data-role="content">
                  ...
                  <tr>
                    <td width="80%">
                        ...
                        <td style="text-align: right">
                            <input data-inline="true" value="取消等待" data-mini="true" type="button" onclick="subQuery('cancel')" />
                        </td>
                    </tr>
                    <tr>
                        <td width="80%">
            ...
            <asp:DataList ID="DataListWaitSeat" runat="server" RepeatDirection="Horizontal" RepeatColumns="4"
                class="dlClass" Width="100%">
                <ItemTemplate>
                    <div id="divItem" runat="server" data-role="fieldcontain" style="width: 25%; height: 30px;
                        margin-left: 0; margin-top: 0">
                        <div onclick='ShowWaitMessage(&quot;<%# Eval("SeatNo")%>&quot;,&quot;<%# Eval("ShortSeatNo")%>&quot;)'
