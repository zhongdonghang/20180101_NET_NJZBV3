...
namespace SchoolPocketBookOnlineV2.UserInfos
{
    public partial class BlackList : BasePage
    {
        ...
        private void BindBlacklistInfo(int intDate)
        {
            ...
            List<BlackListInfo> blacklists = handler.GetBlackList(this.UserSchoolInfo, cardNo, intDate);// blackListBll.GetBlackList(cardNo, intDate, Session["SchoolConnectionString"].ToString());
