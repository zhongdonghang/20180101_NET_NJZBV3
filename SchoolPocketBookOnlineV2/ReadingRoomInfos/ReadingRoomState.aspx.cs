...
namespace SchoolPocketBookOnlineV2.ReadingRoomInfos
{
    public partial class ReadingRoomState : BasePage
    {
        ...
        private void BindDataList()
        {
            ...
            Dictionary<string, ReadingRoomSeatUsedState_Ex> dic = handler.GetAllRoomSeatUsedState(this.UserSchoolInfo);// bll.GetReadingRoomSeatUsingState(roomNums, Session["SchoolConnectionString"].ToString());
