<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BookModelChoose.aspx.cs"
    Inherits="SchoolPocketBookOnlineV2.BookSeat.BookModelChoose" %>
     ...
     <div data-role="content">
            <div class="ui-grid-b" style="margin-top: 0; margin-left: 0">
                <div class="ui-block-a">
                    <a id="btn_NowDay" class="btn_BookNowDaySeat" runat="server"  data-role="button" rel="external" href="../BookSeat/BookNowSeatListForm.aspx">
                    </a>
                </div>
                ...
                <div class="ui-block-c">
                    <a class="btn_BookNextDaySeat"  id="btn_NextDay" runat="server"  data-role="button" rel="external" href="../BookSeat/BookSeatListForm.aspx">
                    </a>
                </div>
            </div>
