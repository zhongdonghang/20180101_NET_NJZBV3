<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BookSeatListForm.aspx.cs" Inherits="SchoolPocketBookOnlineV2.BookSeat.BookSeatListForm" %>
            ...
            <asp:DataList ID="DataListBookSeat" runat="server" RepeatDirection="Horizontal" RepeatColumns="4"
                ...
                <ItemTemplate>
                    <div id="divItem" runat="server" data-role="fieldcontain" style="width: 25%; height: 30px;
                        ...
                        <div onclick='ShowBookMessage(&quot;<%# Eval("SeatNo")%>&quot;,&quot;<%# Eval("ShortSeatNo")%>&quot;,&quot;<%# Eval("CanBespeakStr")%>&quot;)'
