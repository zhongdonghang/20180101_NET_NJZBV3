<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MainFunctionPage.aspx.cs"
    Inherits="SchoolPocketBookOnlineV2.MainFunctionPage" %>
        ...
        <div data-role="content">
            <div class="ui-grid-b" style="margin-top: 0; margin-left: 0">
                <div class="ui-block-a">
                    <a class="btn_MySeat" data-role="button" rel="external" href="UserInfos/UserInfo.aspx">
                    </a>
                </div>
                <div class="ui-block-b">
                    <a class="btn_UsedState" data-role="button" rel="external" href="ReadingRoomInfos/ReadingRoomState.aspx">
                    </a>
                    <%--<a runat="server" class="btn_SelectSeat" data-role="button" href="SelectSeat/SeatList.aspx"></a>--%>
                </div>
                ...
                <div class="ui-block-c">
                    <a id="btn_WaitSeat" runat="server" class="btn_WaitSeat" rel="external" data-role="button"
                        href="WaitSeat/WaitSeatListForm.aspx"></a>
                </div>
                <div class="ui-block-a">
                &nbsp;
