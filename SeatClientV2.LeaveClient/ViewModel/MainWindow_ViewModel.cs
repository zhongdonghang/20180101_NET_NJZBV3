...
namespace ClientLeaveV2.ViewModel
{
    public class MainWindow_ViewModel : INotifyPropertyChanged
    {
        ...
        /// 基础类
        /// </summary>
        public ClientLeaveV2.OperateResult.SystemObject clientObject
        {
            get { return ClientLeaveV2.OperateResult.SystemObject.GetInstance(); }
        }
        ...
        public void PosCardHandle(string cardNo)
        {
            ...
            catch (Exception ex)
            {
                ...
                ClientLeaveV2.PopupWindow popWindow = new PopupWindow(TipType.Exception);
