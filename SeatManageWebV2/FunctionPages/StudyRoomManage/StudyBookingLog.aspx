<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StudyBookingLog.aspx.cs"
    Inherits="SeatManageWebV2.FunctionPages.StudyRoomManage.StudyBookingLog" %>
...
<body>
            ...
            <ext:FormRow ColumnWidths="25% 75%">
                <Items>
                    <ext:DropDownList ID="ddlStudyState" runat="server" Width="150px" Label="审核状态">
                        ...
                        <ext:ListItem Text="等待审核" Value="0" />
    ...
    <ext:Grid ID="gridStudyLog" Title="预约记录查询" AllowSorting="true" SortColumnIndex="5"
        ...
        <Columns>
            ...
            <ext:BoundField Width="100px" DataField="StudyRoomNo" SortField="StudyRoomNo" DataFormatString="{0}"
                HeaderText="研习间编号" />
            <ext:BoundField Width="150px" DataField="CardNo" SortField="CardNo" DataFormatString="{0}"
                HeaderText="提交人卡号" />
            <ext:BoundField Width="150px" DataField="MeetingName" SortField="MeetingName" DataFormatString="{0}"
                HeaderText="会议名称" />
            <ext:BoundField Width="120px" DataField="SubmitTime" SortField="SubmitTime" DataFormatString="{0:yy/MM/dd HH:mm}"
                HeaderText="提交时间" />
            <ext:BoundField Width="120px" DataField="BespeakTime" SortField="BespeakTime" DataFormatString="{0:yy/MM/dd HH:mm}"
                HeaderText="预约时间" />
            ...
            <ext:LinkButtonField Width="40px" CommandName="ActionWatchStudyLog" Icon="Zoom"
                TextAlign="Center" ToolTip="审查申请" ColumnID="StudyWatch" HeaderText="审查" />
        </Columns>
    </ext:Grid>
