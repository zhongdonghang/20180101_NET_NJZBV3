<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BespeakNowDaySeat.aspx.cs" Inherits="SeatManageWebV2.FunctionPages.SeatBespeak.BespeakNowDaySeat" %>
...
<body>
    ...
    <ext:Grid ID="gridRoomList" Title="阅览室列表" AllowSorting="true" SortColumnIndex="0"
        ...
        <Columns>
            ...
            <ext:BoundField Width="100px" DataField="SeatAmount" SortField="SeatAmount"
                DataFormatString="{0}" TextAlign="Center" HeaderText="座位总数" />
