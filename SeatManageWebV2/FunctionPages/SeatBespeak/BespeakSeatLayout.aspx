<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BespeakSeatLayout.aspx.cs" Inherits="SeatManageWebV2.FunctionPages.SeatBespeak.BespeakSeatLayout" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        $(document).ready(
            function () {
                loadBespeakSeatLayout();
                intervalRun();
            })

        function intervalRun() {
            var interval;
            interval = setInterval(loadBespeakSeatLayout, '5000');
        }
    </script>
</head>
<body>
    ...
    <ext:PageManager ID="PageManager" runat="server" AutoSizePanelID="RegionPanel_1"
        HideScrollbar="true" />
    <ext:Window ID="seatBespeakWindow" Title="预约确认" Popup="false" EnableIFrame="true"
    ...
    <input type="hidden" id="hiddenDate" value="<%=bespeakDate %>" />
