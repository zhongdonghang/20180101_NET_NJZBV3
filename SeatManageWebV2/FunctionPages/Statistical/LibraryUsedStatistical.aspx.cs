...
{
    public partial class LibraryUsedStatistical : BasePage
    {
        ...
        private void LibDataBinding()
        {
            ...
            librarySeatUsedInfo.ChartAreas[0].Area3DStyle.PointDepth = 100;
            ...
            librarySeatUsedInfo.Series["SeatAmount"].Points.DataBindXY(dv, "ReadingRoomName", dv, "SeatAmount");
