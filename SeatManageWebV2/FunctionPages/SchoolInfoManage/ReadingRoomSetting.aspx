        ...
        <ext:Panel ID="PanelSetting" ClientIDMode="Static" runat="server" EnableBackgroundColor="false"
            ...
            <Items>
                <ext:ContentPanel BoxConfigAlign="Center" runat="server" BodyPadding="3px" ShowHeader="true"
                    ...
                    <table width="90%">
                        <tr>
                            ...
                            <td align="left" width="80px">启用高级设置
                            </td>
                            <td align="left">
                        ...
                        <tr>
                            ...
                            <td colspan="2">
                                <table width="600" cellspacing="0" cellpadding="5" border="1" class="borderStyle">
                                    <tr>
                                        <td class="borderStyle" style="font-weight: bold;" width="75px">计划日期
                                        </td>
                                        <td class="borderStyle" width="250px" style="font-weight: bold;">时间段
                                        </td>
                                        <td class="borderStyle" width="200px" style="font-weight: bold;">选座方式
                                        </td>
                                        <td class="borderStyle" width="80px" style="font-weight: bold;"></td>
                                    </tr>
                                    <tr>
                                        <td class="borderStyle" valign="middle">
                                            <asp:CheckBox ClientIDMode="Static" ID="SeatSelectAdModeDay1" runat="server" Text="周一" />
                                        </td>
                                        <td class="borderStyle" valign="middle">时间段1：
                                    ...
                                    <tr>
                                        <td class="borderStyle" valign="middle"></td>
                                        <td class="borderStyle" valign="middle">时间段2：
                                    ...
                                    <tr>
                                        <td class="borderStyle" valign="middle"></td>
                                        <td class="borderStyle" valign="middle">时间段3：
                        ...
                        <tr>
                            ...
                            <td>
                                <table width="520" cellspacing="0" cellpadding="5" border="1" class="borderStyle">
                                    <tr>
                                        <td class="borderStyle" style="font-weight: bold;">计划
                                        </td>
                                        <td class="borderStyle" width="200px" style="font-weight: bold;">时间段
                                        </td>
                                        <td class="borderStyle" width="120px" style="font-weight: bold;">保留时长
                                        </td>
                                        <td class="borderStyle" width="80px" style="font-weight: bold;"></td>
                                    </tr>
                                    <tr height="">
                            ...
                            <td>
                                <table>
                                    <tr height="30" valign="middle">
                                        <td class="borderStyle" valign="top">开馆时间：
                                        </td>
                                        <td class="borderStyle" valign="top">
                                        ...
                                        <td class="borderStyle" valign="top">开馆预处理时长:
                                    ...
                                    <tr height="30" valign="middle">
                                        <td class="borderStyle" valign="top">闭馆时间：
                                        </td>
                                        <td class="borderStyle" valign="top">
                                        ...
                                        <td class="borderStyle" valign="top">闭馆预处理时长:
                                ...
                                <table id="ReadingRoomOpenCloseAdModeTable" runat="server" width="90%" style="display: none">
                                    <tr>
                                        <td class="borderStyle" valign="top" width="100"></td>
                                        <td class="borderStyle" valign="top" colspan="2">
                                            <table>
                                                <tr>
                                                    <td class="borderStyle" style="font-weight: bold;">计划日期
                                                    </td>
                                                    <td class="borderStyle" style="font-weight: bold;">开馆时间
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td class="borderStyle" valign="top">
                                                    ...
                                                    <td class="borderStyle" valign="middle">时段1：<br />
                                                        时段2：<br />
                                                        时段3：
                                                    </td>
                                                    <td class="borderStyle" valign="top">
                    ...
                    <table width="90%">
                        <tr>
                            ...
                            <td>
                                ...
                                <table width="520" cellspacing="0" cellpadding="5" border="1" class="borderStyle">
                                    <tr id="seatTimeModeltr" runat="server">
                                        <td class="borderStyle" width="100px">限制时长模式：
                                        </td>
                                    ...
                                    <tr>
                                        <td class="borderStyle" width="100px">座位使用时长：
                                        </td>
                                        <td class="borderStyle" colspan="2">
                                    ...
                                    <tr id="timespanlisttr" runat="server">
                                        <td class="borderStyle" width="100px">固定时段：
                                        </td>
                                        <td>
                                        ...
                                        <asp:TextBox Height="13px" ID="SeatTime_TimeM_3" runat="server" Width="25" ClientIDMode="Static"></asp:TextBox>--%>
                                            <asp:TextBox Height="13px" ID="SeatTime_TimeSpanList" runat="server" Width="300px" ClientIDMode="Static" EmptyText="示例:8:00;10:00;12:00"></asp:TextBox>
                                        </td>
                                        <td class="borderStyle">
                                            <span id="SeatTime_TimeSpan_0_Error" title="" style="color: Red;"></span><span id="SeatTime_TimeSpan_1_Error"
                                                title="" style="color: Red;"></span><span id="SeatTime_TimeSpan_2_Error" title=""
                                                    style="color: Red;"></span><span id="SeatTime_TimeSpan_3_Error" title="" style="color: Red;"></span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="borderStyle">超时处理方式：
                                        </td>
                        ...
                        <tr>
                            ...
                            <td title="0次为不限制续时次数" class="borderStyle" valign="top">可续时次数：
                                <asp:TextBox Height="13px" ID="SeatTime_ContinueTime_ContinueCount" runat="server"
                                    Width="25" ClientIDMode="Static"></asp:TextBox>次（0为不限制次数）&nbsp;
                ...
                <ext:ContentPanel ID="cp1" BoxConfigAlign="Center" runat="server" BodyPadding="3px"
                    ...
                    <table width="90%">
                        <tr>
                            <td class="borderStyle" valign="top" width="150px" title="读者通过预约网站可以进行的离开操作">允许座位操作：
                            </td>
                            <td>
                    ...
                    <table width="90%">
                        <tr>
                            ...
                            <td class="borderStyle">
                                ...
                                <asp:CheckBox ClientIDMode="Static" ID="cbSpecifiedBook" runat="server" Text="启用自定义时间预约" />
                            </td>
                        </tr>
                        <tr>
                            <td class="borderStyle" valign="top" width="150">
                            ...
                            <td class="borderStyle">
                                <table width="500px" cellspacing="0" cellpadding="5" border="1" class="borderStyle">
                                    <tr>
                                        <td class="borderStyle" valign="top">预约提前：
                                        </td>
                                    ...
                                    <tr>
                                        <td class="borderStyle" valign="top">开放预约时间：
                                        </td>
                                    ...
                                    <tr>
                                        <td class="borderStyle" title="设置不允许预约的日期，起始和结束日期用“~”分割，多个日期段间“;”分隔，请不要输入任何中文字符，">不开放预约的日期：
                                        </td>
                                        <td class="borderStyle" valign="top">
                        ...
                        <tr id="appointTimetr" runat="server">
                            <td class="borderStyle" valign="top" width="150">
                                <span>预约时间段设置：</span>
                            </td>
                            <td class="borderStyle">
                                <table width="500px" cellspacing="0" cellpadding="5" border="1" class="borderStyle">
                                    ...
                                    <tr>
                                        <td class="borderStyle" title="设置指定预约的时段，多个时段间“;”分隔，请不要输入任何中文字符，">指定预约的时段：
                                        </td>
                                        <td class="borderStyle" valign="top">
                        ...
                        <tr>
                            ...
                            <td class="borderStyle" valign="top">
                                <span id="SeatBook_SeatBookRadioPercent_Percent_Error" title="" style="color: Red;"></span>
                            </td>
                        </tr>
                        <tr id="nowDaytr1" runat="server">
                            <td class="borderStyle" valign="top" width="150">
                                <span>当天预约设置：</span>
                            </td>
                            <td class="borderStyle">每天可预约座位<asp:TextBox Height="13px" ID="SeatBook_BespeakSeatCount" runat="server" Width="25"
                                ClientIDMode="Static"></asp:TextBox>次（不计算取消的预约） <span id="SeatBook_BespeakSeatCount_Error"
                                    title="" style="color: Red;"></span>
                            </td>
                        </tr>
                        <tr id="nowDaytr2" runat="server">
                            <td class="borderStyle" valign="top" width="150">&nbsp;
                            </td>
                            <td class="borderStyle">
                        ...
                        <tr>
                            <td class="borderStyle" width="150">预约签到设置：
                            </td>
                            <td class="borderStyle" valign="top">可以提前
                        ...
                        <tr id="nowDaytr3" runat="server">
                            <td class="borderStyle" valign="top" width="150">&nbsp</td>
                            <td class="borderStyle">及时预约座位保留时间：
                            <asp:TextBox Height="13px" ID="NowDayBookTime" runat="server" Width="25" ClientIDMode="Static"></asp:TextBox>&nbsp;分钟(预约完成后请在此时间内刷卡确认座位)
                            <span id="NowDayBookTime_Error" title="" style="color: Red;"></td>
                        </tr>
                    </table>
                </ext:ContentPanel>
                <ext:ContentPanel ID="ContentPanel2" BoxConfigAlign="Center" runat="server" BodyPadding="3px"
                    ...
                    <table width="90%" id="UseBlacklistSettingTable" runat="server" style="display: none">
                        <tr>
                            <td class="borderStyle" valign="top" width="150"></td>
                            <td class="borderStyle" valign="top" width="180">进入黑名单的违规次数（次）：
                            </td>
                            <td class="borderStyle" valign="top">
                        ...
                        <tr>
                            <td class="borderStyle" valign="top" width="150"></td>
                            <td class="borderStyle" valign="top" width="180">离开黑名单方式
                            </td>
                            <td class="borderStyle" valign="top">
                        ...
                        <tr>
                            <td class="borderStyle" valign="top" width="150"></td>
                            <td class="borderStyle" valign="top" width="180">离开黑名单天数（天）：
                            </td>
                            <td class="borderStyle" valign="top">
                        ...
                        <tr>
                            <td class="borderStyle" valign="top" width="150"></td>
                            <td class="borderStyle" valign="top" width="180">违规记录失效天数（天）：
                            </td>
                            <td class="borderStyle" valign="top">
                        ...
                        <tr>
                            <td class="borderStyle" valign="top" width="150"></td>
                            <td class="borderStyle" valign="top" width="180">启用违规类型：
                            </td>
                            <td class="borderStyle" valign="top">
                        ...
                        <tr>
                            <td class="borderStyle" valign="top" width="150"></td>
                            <td class="borderStyle" valign="top" width="180"></td>
                            <td class="borderStyle" valign="top">
                ...
                <ext:ContentPanel ID="ContentPanel5" BoxConfigAlign="Center" runat="server" BodyPadding="3px"
                    ...
                    <table>
                        ...
                        <tr>
                            <td class="borderStyle" valign="top" width="150"></td>
                            <td class="borderStyle" valign="top">读者类型：
                            </td>
                        </tr>
                        <tr>
                            <td class="borderStyle" valign="top" width="150"></td>
                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <td class="borderStyle" valign="top" align="center">
                                <asp:Button ID="Button1" runat="server" OnClick="Submit_OnClick" Text="保存设置" OnClientClick=" return SettingVerification()"></asp:Button>
                            </td>
                        </tr>
                    </table>
                </ext:ContentPanel>
