...
namespace LikeIE
{
    public class DeleteCache
    {
        ...
        public static void ClearedIECache()
        {
            ...
            LikeIE.DeleteCache.INTERNET_CACHE_ENTRY_INFOA internetCacheEntry;
            ...
            enumHandle = DeleteCache.FindFirstUrlCacheGroup(0, CACHEGROUP_SEARCH_ALL, IntPtr.Zero, 0, ref groupId, IntPtr.Zero);
            ...
            while (true)
            {
                ...
                returnValue = DeleteCache.DeleteUrlCacheGroup(groupId, CACHEGROUP_FLAG_FLUSHURL_ONDELETE, IntPtr.Zero);
                if (!returnValue && ERROR_FILE_NOT_FOUND == Marshal.GetLastWin32Error())
                {
                    returnValue = DeleteCache.FindNextUrlCacheGroup(enumHandle, ref groupId, IntPtr.Zero);
                }
