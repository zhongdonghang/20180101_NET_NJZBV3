...
namespace SchoolPocketBookWeb.StudyRoom
{
    public partial class StudyRoomList : BasePage
    {
        ...
        private void BindDataList()
        {
            ...
            List<StudyRoomInfo> rooms = handler.GetStudyRoomList();// bll.GetReadingRoomSeatUsingState(roomNums, Session["SchoolConnectionString"].ToString());
            foreach (StudyRoomInfo room in rooms)
            {
