<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StudyRoomList.aspx.cs"
    Inherits="StudyRoomWeb.FunctionPages.BespeakStudyRoom.StudyRoomList" %>
    ...
    <ext:PageManager ID="PageManager" runat="server" AutoSizePanelID="RegionPanel_1" />
        <ext:Grid ID="gridRoomList" Title="研习间列表" AllowSorting="true" SortColumnIndex="0"
            ...
            <Columns>
                ...
                <%--            <ext:BoundField Hidden="true" Width="200px" DataField="FacilitiesRenmark" SortField="RemaFacilitiesRenmarkrk"
                DataFormatString="{0}" TextAlign="Left" HeaderText="设备描述" />
            <ext:BoundField Hidden="true" Width="200px" DataField="Precautions" SortField="Precautions"
                DataFormatString="{0}" TextAlign="Left" HeaderText="注意事项" />
            <ext:BoundField Hidden="true" Width="200px" DataField="ApplicationInfo" SortField="ApplicationInfo"
                DataFormatString="{0}" TextAlign="Left" HeaderText="申请说明" />--%>
                ...
                <%--            <ext:TemplateField  Width="200px" TextAlign="Left" HeaderText="设备描述">
                <ItemTemplate>
                    <div runat="server" id="divRemaFacilitiesRenmarkrk">
                    </div>
                </ItemTemplate>
            </ext:TemplateField>
            <ext:TemplateField  Width="200px" TextAlign="Left" HeaderText="注意事项">
                <ItemTemplate>
                    <div runat="server" id="divPrecautions">
                    </div>
                </ItemTemplate>
            </ext:TemplateField>
            <ext:TemplateField Width="200px" TextAlign="Left" HeaderText="申请说明">
                <ItemTemplate>
                    <div runat="server" id="divApplicationInfo">
                    </div>
                </ItemTemplate>
            </ext:TemplateField>--%>
                <ext:LinkButtonField Width="80px" CommandName="AppTable" IconUrl="/Images/Hand.png"
