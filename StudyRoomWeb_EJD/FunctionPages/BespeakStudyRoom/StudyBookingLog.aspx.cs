...
{
    public partial class StudyBookingLog : Page
    {
        ...
        protected void gridStudyLog_OnPreRowDataBound(object sender, FineUI.GridPreRowEventArgs e)
        {
            ...
            else
            {
                ...
                lbf1.OnClientClick = WindowEdit.GetShowReference(string.Format("StudyBookingLogCheck.aspx?id={0}", row[0].ToString()), "查看申请");
            }
