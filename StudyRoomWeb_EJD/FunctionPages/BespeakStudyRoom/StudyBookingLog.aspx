<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StudyBookingLog.aspx.cs"
    Inherits="StudyRoomWeb.FunctionPages.BespeakStudyRoom.StudyBookingLog" %>
...
<body>
        ...
        <Rows>
            <ext:FormRow ColumnWidths="25% 25% 50%">
                <Items>
                    ...
                    <ext:Label runat="server" Height="24px">
                    </ext:Label>
                </Items>
            </ext:FormRow>
            <ext:FormRow ColumnWidths="25% 25% 50%">
                <Items>
                    <ext:TextBox runat="server" ID="txtCardNo" Label="证件号" Width="150px">
                    </ext:TextBox>
    ...
    <ext:Grid ID="gridStudyLog" Title="申请记录查询" AllowSorting="true" SortColumnIndex="4"
        ...
        <Columns>
            ...
            <ext:LinkButtonField Width="80px" CommandName="ActionUpdataStudyLog" Icon="Pencil"
                TextAlign="Center" ToolTip="修改申请" ColumnID="StudyUpdate" HeaderText="修改/查看" />
            <ext:LinkButtonField Width="40px" CommandName="ActionDeleteStudyLog" Icon="Delete"
                TextAlign="Center" ToolTip="取消申请" ColumnID="StudyDelete" HeaderText="取消" />
        </Columns>
    </ext:Grid>
    ...
    <ext:Window ID="WindowCancel" Title="取消申请" Popup="false" EnableIFrame="true" IFrameUrl="about:blank"
        EnableMaximize="true" Target="Top" EnableResize="false" runat="server" CloseAction="HidePostBack"
        EnableClose="true" IsModal="true" Width="400px" EnableConfirmOnClose="true" OnClose="WindowEdit_Close"
        Height="170px">
    </ext:Window>
    </form>
</body>
