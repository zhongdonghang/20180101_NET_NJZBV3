...
{
    public class ReadSeatHostConfigV2
    {
    ...
    public class HostConfig
    {
        ...
        string _WeChatWCFString = "";
        /// <summary>
        /// 微信WCF连接字符串
        /// </summary>
        public string WeChatWCFString
        {
            get { return _WeChatWCFString; }
            set { _WeChatWCFString = value; }
        }
        string _AdrWcfString = "net.tcp://180.96.23.214:10086/";
        /// <summary>
        /// 180wcf连接字符串
        /// </summary>
        ...
        string _AdvSocketString = "180.96.23.214:12306";
        /// <summary>
        /// Socket连接字符
        /// </summary>
