...
namespace SeatClient.Config
{
    public partial class Form1 : Form
    {
        ...
        SeatManage.ClassModel.TerminalInfoV2 terminal = null;
        ...
        {
            terminal = SeatManage.Bll.TerminalOperatorService.GetTeminalSetting(this.txtTerminalNum.Text);
            if (terminal != null)
            {
            ...
            switch (terminal.DeviceSetting.UsingPrintSlip)
            {
                case SeatManage.EnumType.PrintSlipMode.AutoPrint:
                    rbPrint.Checked = true;
                    break;
                case SeatManage.EnumType.PrintSlipMode.NotPrint:
                    rbNoPrint.Checked = true;
                    break;
                case SeatManage.EnumType.PrintSlipMode.UserChoose:
                    rbChangePrint.Checked = true;
                    break;
            }
            switch (terminal.DeviceSetting.SystemResoultion.WindowSize.Size.X)
            {
                case 1024:
                    rdb1024.Checked = true;
                    break;
                case 1280:
                    rdb1280.Checked = true;
                    break;
                case 1440:
                    rdb1440.Checked = true;
                    break;
                case 1920:
                    rdb1920.Checked = true;
                    break;
                case 1080:
        ...
        private void GetNewConfig()
        {
            ...
            if (rbChangePrint.Checked)
            {
                terminal.DeviceSetting.UsingPrintSlip = SeatManage.EnumType.PrintSlipMode.UserChoose;
            }
            else if (rbPrint.Checked)
            {
                terminal.DeviceSetting.UsingPrintSlip = SeatManage.EnumType.PrintSlipMode.AutoPrint;
            }
            else if (rbNoPrint.Checked)
            {
                terminal.DeviceSetting.UsingPrintSlip = SeatManage.EnumType.PrintSlipMode.NotPrint;
            }
            ...
            else if (rdb1280.Checked)
            {
                resoultion("1280");
            }
            else if (rdb1440.Checked)
            {
                resoultion("1440");
            }
            else if (rdb1920.Checked)
            {
                resoultion("1920");
            }
        ...
        void resoultion(string r)
        {
            switch (r)
            {
                case "1080":
                    ...
                    terminal.DeviceSetting.SystemResoultion.TooltipSize.Location.X = 245;
                    terminal.DeviceSetting.SystemResoultion.TooltipSize.Location.Y = 1165;
                    terminal.DeviceSetting.SystemResoultion.TooltipSize.Size.X = 590;
                    terminal.DeviceSetting.SystemResoultion.TooltipSize.Size.Y = 470;
                    break;
                case "1024":
                    terminal.DeviceSetting.SystemResoultion.WindowSize.Location.X = 0;
                    ...
                    terminal.DeviceSetting.SystemResoultion.TooltipSize.Location.X = 217;
                    terminal.DeviceSetting.SystemResoultion.TooltipSize.Location.Y = 145;
                    terminal.DeviceSetting.SystemResoultion.TooltipSize.Size.X = 590;
                    terminal.DeviceSetting.SystemResoultion.TooltipSize.Size.Y = 470;
                    break;
                case "1280":
                    terminal.DeviceSetting.SystemResoultion.WindowSize.Location.X = 0;
                    terminal.DeviceSetting.SystemResoultion.WindowSize.Location.Y = 0;
                    terminal.DeviceSetting.SystemResoultion.WindowSize.Size.X = 1280;
                    terminal.DeviceSetting.SystemResoultion.WindowSize.Size.Y = 800;
                    terminal.DeviceSetting.SystemResoultion.TooltipSize.Location.X = 217;
                    terminal.DeviceSetting.SystemResoultion.TooltipSize.Location.Y = 145;
                    terminal.DeviceSetting.SystemResoultion.TooltipSize.Size.X = 590;
                    terminal.DeviceSetting.SystemResoultion.TooltipSize.Size.Y = 470;
                ...
                case "1440":
                    terminal.DeviceSetting.SystemResoultion.WindowSize.Location.X = 0;
                    terminal.DeviceSetting.SystemResoultion.WindowSize.Location.Y = 0;
                    terminal.DeviceSetting.SystemResoultion.WindowSize.Size.X = 1440;
                    terminal.DeviceSetting.SystemResoultion.WindowSize.Size.Y = 900;
                    terminal.DeviceSetting.SystemResoultion.TooltipSize.Location.X = 217;
                    terminal.DeviceSetting.SystemResoultion.TooltipSize.Location.Y = 145;
                    terminal.DeviceSetting.SystemResoultion.TooltipSize.Size.X = 590;
                    terminal.DeviceSetting.SystemResoultion.TooltipSize.Size.Y = 470;
                ...
                case "1920":
                    terminal.DeviceSetting.SystemResoultion.WindowSize.Location.X = 0;
                    terminal.DeviceSetting.SystemResoultion.WindowSize.Location.Y = 0;
                    terminal.DeviceSetting.SystemResoultion.WindowSize.Size.X = 1920;
                    terminal.DeviceSetting.SystemResoultion.WindowSize.Size.Y = 1080;
                    terminal.DeviceSetting.SystemResoultion.TooltipSize.Location.X = 217;
                    terminal.DeviceSetting.SystemResoultion.TooltipSize.Location.Y = 145;
                    terminal.DeviceSetting.SystemResoultion.TooltipSize.Size.X = 590;
                    terminal.DeviceSetting.SystemResoultion.TooltipSize.Size.Y = 470;
