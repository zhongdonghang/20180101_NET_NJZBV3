...
namespace SeatManage.DataModel
{
    public class AccessSetting
    {
        ...
        private SystemCode.EnumType.EnterOutLogType _LeaveMode = SystemCode.EnumType.EnterOutLogType.ShortLeave;
        /// <summary>
        /// 离开处理模式
        /// </summary>
        public SystemCode.EnumType.EnterOutLogType LeaveMode
        {
        ...
        public AccessSetting ToSetting(string Xml)
        {
            ...
            {
                this._OutLib = true;
                this.LeaveMode = SystemCode.EnumType.EnterOutLogType.ShortLeave;
            }
            else
            {
                this._OutLib = bool.Parse(node.Attributes["IsUsed"].Value);
                this.LeaveMode = (SystemCode.EnumType.EnterOutLogType)int.Parse(node.Attributes["LeaveMode"].Value);
            }
