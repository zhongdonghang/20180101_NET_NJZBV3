...
namespace SeatManage.DataModel
{
    public class AMS_AdvertUsage : AdvertisementUsage
    {
        ...
        private SystemCode.EnumType.AdType _AdvertType = EnumType.AdType.None;
        /// <summary>
        /// 广告类型
        /// </summary>
        public SystemCode.EnumType.AdType AdvertType
        {
        ...
        public static AMS_AdvertUsage ToModel(string xml)
        {
            ...
            try
            {
                ...
                model.AdvertType = (SystemCode.EnumType.AdType)System.Enum.Parse(typeof(SystemCode.EnumType.AdType), node.Attributes["AdvertType"].Value);
