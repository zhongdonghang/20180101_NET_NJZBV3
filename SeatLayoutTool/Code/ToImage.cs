        ...
        public void Draw(string savePath)
        {
            try
            {
                using (Bitmap bmp = new Bitmap((_Layout.SeatCol + 1) * 25 + 20, (_Layout.SeatRow + 1) * 25 + 20))//绘制画布大小
                {
                    ...
                    {
                        Image imgSeat = global::SeatLayoutTool.Properties.Resources.Seat;
                        Point[] points = { 
                                         new Point(0,0),
                                         new Point(48, 0), 
                                         new Point(0, 48),
                    ...
                    {
                        Image imgNote = global::SeatLayoutTool.Properties.Resources.blank;
                        switch (_Layout.Notes[i].Type)
                        {
                            case SeatManage.EnumType.OrnamentType.AirConditioning:
                                imgNote = global::SeatLayoutTool.Properties.Resources.AirConditioning;
                                break;
                            case SeatManage.EnumType.OrnamentType.Bookshelf:
                                imgNote = global::SeatLayoutTool.Properties.Resources.Bookshelf;
                                break;
                            case SeatManage.EnumType.OrnamentType.Door:
                                imgNote = global::SeatLayoutTool.Properties.Resources.Door;
                                break;
                            case SeatManage.EnumType.OrnamentType.PCTable:
                                imgNote = global::SeatLayoutTool.Properties.Resources.PCTable;
                                break;
                            case SeatManage.EnumType.OrnamentType.Pillar:
                                imgNote = global::SeatLayoutTool.Properties.Resources.Pillar;
                                break;
                            case SeatManage.EnumType.OrnamentType.Plant:
                                imgNote = global::SeatLayoutTool.Properties.Resources.Plant;
                                break;
                            case SeatManage.EnumType.OrnamentType.Roundtable:
                                imgNote = global::SeatLayoutTool.Properties.Resources.Roundtable;
                                break;
                            case SeatManage.EnumType.OrnamentType.Steps:
                                imgNote = global::SeatLayoutTool.Properties.Resources.Steps;
                                break;
                            case SeatManage.EnumType.OrnamentType.Table:
                                imgNote = global::SeatLayoutTool.Properties.Resources.Table;
                                break;
                            case SeatManage.EnumType.OrnamentType.Wall:
                                imgNote = global::SeatLayoutTool.Properties.Resources.Wall;
                                break;
                            case SeatManage.EnumType.OrnamentType.Window:
                                imgNote = global::SeatLayoutTool.Properties.Resources.Window;
                                break;
                            case SeatManage.EnumType.OrnamentType.Elevator:
                                imgNote = global::SeatLayoutTool.Properties.Resources.blank;
                                break;
