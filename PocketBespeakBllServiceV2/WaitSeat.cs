    ...
    public partial class PocketBespeakBllService : IPocketBespeakBllServiceV2.IPocketBespeakBllService
    {
        ...
        public bool IsCanWaitSeat(string CardNo, string roomNo)
        {
            try
            {
                ...
                List<ReadingRoomInfo> roomInfos = seatManage.GetReadingRoomInfo(new List<string>() { roomNo });
        ...
        public string CancelWait(WaitSeatLogInfo waitInfo)
        {
            try
            {
                ...
                List<ReadingRoomInfo> roomInfos = seatManage.GetReadingRoomInfo(new List<string>() { waitInfo.ReadingRoomNo });
                if (roomInfos.Count > 0)
                {
