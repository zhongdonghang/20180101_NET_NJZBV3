...
namespace AMS.DAL
{
	...
	public partial class SlipReleaseCampus
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("id", "SlipReleaseCampus"); 
		}
		...
		public bool Exists(int id)
		{
			...
			strSql.Append("select count(1) from SlipReleaseCampus");
		...
		/// 增加一条数据
		/// </summary>
		public int Add(AMS.Model.SlipReleaseCampus model)
		{
			StringBuilder strSql=new StringBuilder();
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(AMS.Model.SlipReleaseCampus model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update SlipReleaseCampus set ");
		...
		public bool Delete(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from SlipReleaseCampus ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
};
		...
		/// 得到一个对象实体
		/// </summary>
		public AMS.Model.SlipReleaseCampus GetModel(int id)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 id,SlipCustomerId,CampusId from SlipReleaseCampus ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
};
			...
			AMS.Model.SlipReleaseCampus model=new AMS.Model.SlipReleaseCampus();
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id,SlipCustomerId,CampusId ");
			strSql.Append(" FROM SlipReleaseCampus ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" id,SlipCustomerId,CampusId ");
			strSql.Append(" FROM SlipReleaseCampus ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "SlipReleaseCampus";
