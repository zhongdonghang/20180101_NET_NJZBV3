...
namespace AMS.DAL
{
	...
	public partial class AMS_AdvertUsage
	{
		...
		/// 增加一条数据
		/// </summary>
		public int Add(AMS.Model.AMS_AdvertUsage model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into AMS_AdvertUsage(");
			strSql.Append("AdvertID,SchoolID,AdvertUsage,LastUpdateTime)");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(AMS.Model.AMS_AdvertUsage model)
		{
			StringBuilder strSql=new StringBuilder();
		...
		/// 得到一个对象实体
		/// </summary>
		public AMS.Model.AMS_AdvertUsage GetModel(int ID)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 ID,AdvertID,SchoolID,AdvertUsage,LastUpdateTime from AMS_AdvertUsage ");
			strSql.Append(" where ID=@ID");
			SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)
};
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select ID,AdvertID,SchoolID,AdvertUsage,LastUpdateTime ");
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" ID,AdvertID,SchoolID,AdvertUsage,LastUpdateTime ");
			strSql.Append(" FROM AMS_AdvertUsage ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
