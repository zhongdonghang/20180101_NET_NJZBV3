<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BookSeatListForm.aspx.cs" Inherits="SchoolPocketBookOnline.BookSeat.BookSeatListForm" %>
...
<head id="Head1" runat="server">
    ...
    <script>
        ...
        function ShowBookMessage(seatNo, seatShortNo) {
            var No = seatNo;
            var ShortNo = seatShortNo;
            var rrid = $("#hidRrId").val();
            var bookDate = $('#txtBookDate').val();
            window.location.href = "BookSeatMessage.aspx?seatNo=" + No + "&seatShortNo=" + ShortNo + "&roomNo=" + rrid + "&date=" + bookDate;
        }
