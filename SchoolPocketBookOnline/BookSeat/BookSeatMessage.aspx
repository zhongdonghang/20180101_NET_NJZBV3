<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BookSeatMessage.aspx.cs" Inherits="SchoolPocketBookOnline.BookSeat.BookSeatMessage" %>
        ...
        <div data-role="content">
            ...
            <div class="ui-grid-a">
                ...
                <div class="ui-block-a" style="width: 50%; text-align: center">
                    <input id="btnSubmit" data-inline="true" value="预约" data-mini="true" type="button" onclick="subQuery('query')" runat="server" />
                </div>
