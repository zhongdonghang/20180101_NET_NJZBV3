...
namespace AMS.Model
{
    public class AMS_AdvertUsage : AdvertisementUsage
    {
        ...
        private Enum.AdType _AdvertType = Enum.AdType.None;
        /// <summary>
        /// 广告类型
        /// </summary>
        public Enum.AdType AdvertType
        {
        ...
        public static AMS_AdvertUsage ToModel(string xml)
        {
            ...
            try
            {
                ...
                model.AdvertType = (Enum.AdType)System.Enum.Parse(typeof(Enum.AdType), node.Attributes["AdvertType"].Value);
