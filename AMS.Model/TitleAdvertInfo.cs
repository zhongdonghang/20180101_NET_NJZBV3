...
namespace AMS.Model
{
    public class TitleAdvertInfo : AMS_Advertisement
    {
        ...
        /// <returns></returns>
        public static string ToXml(TitleAdvertInfo model)
        {
            //TODO:转换成xml结构的算法
            //创建一个xml对象
        ...
        public void ToModel()
        {
            TitleAdvertInfo model = ToModel(AdContent);
            this.Num = model.Num;
        ...
        /// <returns></returns>
        public static TitleAdvertInfo ToModel(string xml)
        {
            ...
            XmlDocument xmlDoc = new XmlDocument();
            TitleAdvertInfo model = new TitleAdvertInfo();
            try
            {
                xmlDoc.LoadXml(xml);
                //查找根节点
