...
namespace AdvertManage.Model
{
    ...
    /// </summary>
    [Serializable]
    public class AMS_PlayListModel
    {
        public AMS_PlayListModel()
        {
            PlayListNo = "";
        ...
        /// <returns></returns>
        public string ToXml(AMS_PlayListModel playlist)
        {
            //TODO:转换成xml结构的算法
            //创建一个xml对象
        ...
        /// <returns></returns>
        public static AMS_PlayListModel Parse(string xmlPlayList)
        {
            AMS_PlayListModel plm = new AMS_PlayListModel();
            XmlDocument xmlDoc = new XmlDocument();
            try
            {
                //载入字符串类型的XML
        ...
        /// <param name="xmlPlayList">xml结构的播放列表</param>
        /// <returns></returns>
        private static AMS_PlayListModel Parse(XmlDocument xmlPlayList)
        {
            AMS_PlayListModel plm = new AMS_PlayListModel();
